...
class lwir_SSDVGG(VGG, BaseModule):
    ...
    def __init__(self,
        ...
        super(lwir_SSDVGG, self).__init__(
            depth,
    ...
    def init_weights(self):
        ...
        state_dict['features.33.weight'] = decimate(conv_fc6_lwir_weight, m=[4, None, 3, 3])  # (1024, 512, 3, 3)
        state_dict['features.33.bias'] = decimate(conv_fc6_lwir_bias, m=[4])  # (1024)
        ...
        state_dict['features.33.weight'] = decimate(conv_fc7_lwir_weight, m=[4, 4, None, None])  # (1024, 1024, 1, 1)
        state_dict['features.33.bias'] = decimate(conv_fc7_lwir_bias, m=[4])  # (1024)
