    ...
    def forward(self, feature0, feature1,
        ...
        if self.attention_type == 'swin' and attn_num_splits > 1: 
            ...
            shifted_window_attn_mask = generate_shift_window_attn_mask(
                input_resolution=(h, w),            # (75, 75)
                window_size_h=window_size_h,        # 4
                window_size_w=window_size_w,        # 4
                shift_size_h=window_size_h // 2,    # 2
                shift_size_w=window_size_w // 2,    # 2
